...
class SearchBarDemoViewController: UIViewController {
    ...
    private var arrayOLabels = ["The Vampire Diaries", "Ted Lasso", "Legacies", "Orignals", "the family man", "Ray", "candy", "Mumbai Diaries", "November Story", "Grahan", "Money Heist", "Squid Game", "Friends", "Vikings"]
