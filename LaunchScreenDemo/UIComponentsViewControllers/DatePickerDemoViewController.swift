...
class DatePickerDemoViewController: UIViewController, UITextFieldDelegate {
    ...
    private let imagePicker = UIPickerView()
    ...
    private var arrayOfImages = [UIImage(systemName: "trash"), UIImage(systemName: "heart.fill"),UIImage(systemName: "folder.fill"), UIImage(systemName: "paperplane.fill"), UIImage(systemName: "book.fill")]
