...
class MapViewController: UIViewController {
    ...
    private var officeLocation = CLLocationCoordinate2D(latitude: 23.024650718994916, longitude: 72.50320354520784)
    private var hotelLocation = CLLocationCoordinate2D(latitude: 23.02704165876138, longitude: 72.50822388559817)
